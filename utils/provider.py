...
class ProviderRegistryMixin(object):
    ...
    def generate_provider_url(self,schema="dubbo",host="127.0.0.1",port="20880",sapplication=None,service=None,methods=None,validate=True,defaultFilter=None,dubbo_v="2.6.8"):
        if methods is None:
            methods = []
        query_map = {
